# Generated by Django 3.0.8 on 2020-10-31 08:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interview_completed', models.DateTimeField()),
                ('offer_position', models.BooleanField(default=False)),
                ('offer_position_completed', models.DateTimeField()),
                ('send_contract', models.BooleanField(default=False)),
                ('send_contract_completed', models.DateTimeField()),
                ('signed_contract', models.BooleanField(default=False)),
                ('signed_contract_completed', models.DateTimeField()),
                ('calendar_invites', models.BooleanField(default=False)),
                ('calendar_invites_completed', models.DateTimeField()),
                ('onboarding', models.BooleanField(default=False)),
                ('onboarding_completed', models.DateTimeField()),
                ('feedback', models.BooleanField(default=False)),
                ('feedback_completed', models.DateTimeField()),
                ('offboarding', models.BooleanField(default=False)),
                ('offboarding_completed', models.DateTimeField()),
                ('mentor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='process', to='mentors.MentorProfile')),
            ],
        ),
    ]

...
class MentorProfileSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        return MentorProfile.objects.create_mentor(**validated_data)

    def update(self, instance, validated_data):
        instance.mentor_name = validated_data.get(
            'mentor_name', instance.mentor_name)
        ...
        instance.mentor_type = validated_data.get(
            'mentor_type', instance.mentor_type)
...
class MentorProcessSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        instance.interview = validated_data.get(
        ...
        instance.offboarding = validated_data.get(
